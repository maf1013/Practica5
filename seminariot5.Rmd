...
-   Implantación de políticas y planes que invierten en la lucha contar el cáncer.
    Nos gustaría destacar la última medida establecida por la Comisión Europa este     año (2024) para la lucha contra el Cáncer.
    Toda la información relacionada con este plan la podemos encontrar en el          siguiente enlace:             https://commission.europa.eu/strategy-and-policy/priorities-2019-2024/promoting-our-european-way-life/european-health-union/cancer-plan-europe_es 



### 6. Relación del cáncer de estómago con la cantidad de fosfatos en ríos.

Como último y principal objetivo de este proyecto, vamos a estudiar si existe algún tipo de relación entre el cáncer de estómago y la cantidad de fosfato en ríos en Europa.

#### 6.1 Metodología y resultados

Para poder analizar estos dos conjuntos de datos, antes de nada tendremos que prepararlos para trabajar con ellos correctamente:

Primero realizaremos una suma de los casos de cancer en hombres con los casos de cáncer en mujeres en cada país y año, y así obtenemos el número de casos total de cáncer de estómago en cada pobalción:
...
A continuación juntaremos ambos conjuntos de datos, obteniendo por cada año y por cada país el numero de casos de cáncer de estómago y la cantidad de fosfato en sus ríos:
...
Por último, queremos estudiar la evolución tanto de los fosfatos en ríos como de los casos de cáncer a lo largo de los años:

Calculamos la media de estas dos variables de todos los países en cada año:
...
Luego pivotamos la tabla que acabamos de obtener para que estas variables calculadas en vez de en columnas aparezcan como filas:
...
Por último creamos un gráfico donde podemos observar la tendencia tanto de la cantidad de fosfato como de casos de cáncer a lo largo del tiempo:
...
Con estos resultados podemos pensar que existe una pequeña relación entre estos dos aspectos. Es decir, que los fosfatos que se encuentran en detergentes, fertilizantes, o producidos por el sector industrial, pueden llegar a los rios dando lugar a una contaminación ambiental. Posteriormente ese agua podrá ser usado para regar en la agricultura, teniendo un impacto en la cadena alimentaria y por lo tanto en la salud humana, espeialmente produciendo problemas digestivos.

Finalmente podemos concluir que el desarrollo de cancer de estómago puede estar relacionado con la cantidad de fosfatos en los ríos. 
Nos gustaría señalizar que la franja temporal en la que se han comparado estos datos no es ni muy grande ni muy actual (año 2006 - año 2013). Por lo que si disponiesemos de más información podríamos realizar unas conclusiones algo más exactatas. Ya que en los últimos años se han impuesto mayores medidas de protección del medio ambientes y se han desarrollado nuevas técnicas y tratamientos de prevención contra el cáncer.

Además, a esta relación de cancer de estómago y fosfatos en ríos se le puede añadir una tercera varibale de estudio, la economía. Donde analizando el PIB de cada país, hemos comprobado que aquellos países con un mayor desarrollo económico tendrán una menor cantidad de casos de cancer y una menor cantidad de fosfatos en sus ríos.
